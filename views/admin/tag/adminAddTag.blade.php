...
@section('content')
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">افزودن تگ</header>
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                <fieldset title="اطلاعات پایه" class="step" id="default-step-0">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" name="label" class="form-control" placeholder="نام تگ">
                                        </div>
                                    </div>
    ...
    <script type="text/javascript" src="{{ asset('admin') }}/js/multiselect.js"></script>
    <script type="text/javascript" src="{{ asset('admin') }}/js/multiselect.min.js"></script>
    ...
    <script src="{{ asset('admin') }}/js/bootstrap-datepicker.fa.min.js"></script>
