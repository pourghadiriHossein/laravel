...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'country' => 'کشور',
        'address' => 'نشانی',
        'phone' => 'شماره تماس (منزل یا همراه)',
        'mobile' => 'شماره همراه',
        'age' => 'سن',
        'sex' => 'جنسیت',
        'gender' => 'جنسیت',
        ...
        'price' => 'مبلغ',
        'techUser' => 'اپراتور',
        'spend_credit' => 'امتیاز مصرفی',
        'code' => 'کد تایید',
        'fixCredit' => 'اصلاح اعتبار',
        'user_id' => 'شناسه کاربر',
        'exchange' => 'ضریب هر اعتبار',
        'credit' => 'اعتبار',
        'avatar' => 'تصویر',
        'message' => 'پیام',
        'type' => 'نوع',
        ...
        'count' => 'مقدار',
        'db' => 'تاریخ تولد',
        'first_ref_user' => 'پاداش اولیه کاربر',
        'repeat_ref_value' => 'پاداش گردشی کاربر',
    ],
