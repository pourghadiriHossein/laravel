...
<head>
    ...
    <title>پرسش و پاسخ متداول</title>
    <link rel="shortcut icon" href="../../IMAGE/logo/TopBarLogo.png" type="image/x-icon">
    <link rel="stylesheet" href="../../CSS/Main.css">
    <link rel="stylesheet" href="../../CSS/FrequencyAndAnswer.css">
</head>
<body>
    ...
    <div class="mainBox menu">
        <ul>
            ...
            <a class="linkMenu" href="../FAQ/FrequencyAndAnswer.html"><li class="active">سوالات متداول</li></a>
