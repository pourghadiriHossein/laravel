    ...
    <div class="contectBox">
        ...
        <div id="productBox" class="showProduct">
            ...
            <div id="4" data-price="563000" data-name="لباس مجلسی" class="imageBox">
                ...
                <a href=""><img src="{{ asset('public') }}/IMAGE/product/dress1-1-700x893.jpg" alt="dress1"></a>
                <div class="secondImageBox">
                    <a href=""><img src="{{ asset('public') }}/IMAGE/product/dress1-2-700x893.jpg" alt="dress1"></a>
                    <a href=""><div>جزئیات</div></a>
                </div>
                <div class="productName">
                    <a href=""><p>لباس مجلسی</p></a>
            ...
            <div id="17" data-price="610000" data-name="تاپ مشکی" class="imageBox">
                <span class="discount"></span>
                <a href=""><img src="{{ asset('public') }}/IMAGE/product/top2-1-700x893.jpg" alt="top2"></a>
                <div class="secondImageBox">
                    <a href=""><img src="{{ asset('public') }}/IMAGE/product/top2-2-700x893.jpg" alt="top2"></a>
                    <a href=""><div>جزئیات</div></a>
                </div>
                <div class="productName">
