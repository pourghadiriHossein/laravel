...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('public') }}/IMAGE/logo/TopBarLogo.png" type="image/x-icon">
...
<body>
    ...
    <div class="mainBox topBarLogo">
        <img src="{{ asset('public') }}/IMAGE/logo/TopBarLogo.png" alt="TopBarLogo">
    </div>
            ...
            <li class="ShopingCartLogo dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a class="linkMenu" href="{{ route('singleProduct') }}">
                        <img class="cart" src="{{ asset('public') }}/IMAGE/product/dress1-1-700x893.jpg" alt="dress1-1">
                        <div class="box">
                            <div class="detail">
                    ...
                    <a class="linkMenu" href="{{ route('singleProduct') }}">
                        <img class="cart" src="{{ asset('public') }}/IMAGE/product/hoodie1-1-700x893.jpg" alt="hoodie1-1">
                        <div class="box">
                            <div class="detail">
                                <span>هودی</span>
                                <del>700000 ريال</del>
                    ...
                    <a class="linkMenu" href="{{ route('singleProduct') }}">
                        <img class="cart" src="{{ asset('public') }}/IMAGE/product/jeans1-1-700x893.jpg" alt="jeans1-1">
                        <div class="box">
                            <div class="detail">
                                <span>شلوار لی</span>
                                <del>500000 ريال</del>
